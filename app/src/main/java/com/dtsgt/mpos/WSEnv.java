...
public class WSEnv extends PBase {
    ...
    private clsD_facturacorObj D_facturacorObj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lbl1 = (TextView) findViewById(R.id.msgHeader);
        lbl1.setText("");
        lbl2 = (TextView) findViewById(R.id.textView151);
        lbl2.setText("");
        ...
        D_facturacorObj=new clsD_facturacorObj(this,Con,db);
    ...
    private void execws(final int callbackvalue) {
        ...
        switch (callbackvalue) {
            case 1:
                plabel = "Enviando Clientes";
                break;
            case 2:
                plabel = "Enviando Facturas";
                break;
            case 3:
                plabel = "Enviando Movimientos de inventario ( " + (fIdxMov + 1) + " )";
                break;
            case 4:
                plabel = "Enviando Caja Cierre";
                break;
            case 5:
                plabel = "Enviando Caja Pagos";
                break;
            case 6:
                plabel = "Enviando Caja Reporte";
                break;
            case 7:
    ...
    private void enviaAnulaciones() {
        try {
            ...
            if (fTotAnul>0) {
                ...
                Intent intent = new Intent(WSEnv.this, srvCommit.class);
    ...
    private void processFactura() {
        ...
        D_facturacorObj.fill("WHERE COREL='" + corel + "'");
        ...
        CSQL = CSQL + "DELETE FROM D_FACTURACOR WHERE COREL='" + corel + "';";
        ...
        for (int i = 0; i < D_factura_svObj.count; i++) {
            CSQL = CSQL + D_factura_svObj.addItemSql(D_factura_svObj.items.get(i)) + ";";
        }
        ...
        for (int i = 0; i < D_facturacorObj.count; i++) {
            CSQL = CSQL + addFacturaCorItem(D_facturacorObj.items.get(i)) + ";";
        }
    ...
    public String addFacturaCorItem(clsClasses.clsD_facturacor item) {
    ...
    public String asistaddItemSql(clsClasses.clsD_usuario_asistencia item) {
        ...
        if (item.fin > 0) fsf = du.univfechahora(item.fin);
        else fsf = "20000101 00:00:00";
        ...
        try {
            ...
            if (gl.peInvCompart) {
                ...
                for (int i = 0; i < P_rutaObj.count; i++)
                    rutas.add("" + P_rutaObj.items.get(i).codigo_ruta);
            }
    ...
    private void updateLabel() {
        ...
        Runnable runnable = () -> handler.post(new Runnable() {
            public void run() {
                lbl1.setText(plabel);
            }
        });
