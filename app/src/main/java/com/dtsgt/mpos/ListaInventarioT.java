...
public class ListaInventarioT extends PBase {

    private ListView listView;
    private TextView lblTipo,lblalm1,lblalm2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_inventario_t);

        super.InitBase();

        listView = findViewById(R.id.listView1);
        lblTipo= findViewById(R.id.lblDescrip2);
        lblalm1= findViewById(R.id.textView268);
        lblalm2= findViewById(R.id.textView269);
    ...
    private void confirmaInventario() {
        try {
            Intent intent = new Intent(ListaInventarioT.this, srvInventConfirm.class);
    ...
    public void nuevo(View view){
        ...
        if (gl.idalm==0) {
            toast("Falta definir almacen origen");listaAlmacenes1();return;
        }

        if (gl.idalm2==0) {
            toast("Falta definir almacen destino");listaAlmacenes2();return;
        }
        ...
        try {
            ...
            Intent intent = new Intent(ListaInventarioT.this, InvTrans.class);
    ...
    public void doAlmacenes1(View view){
        listaAlmacenes1();
    }

    public void doAlmacenes2(View view){
        if (gl.idalm==0) {
            toast("Falta definir almacen origen");listaAlmacenes1();
        } else listaAlmacenes2();
    }
    ...
    private void msgAskResume(String msg) {
        ...
        dialog.setPositiveButton("Reanundar", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                browse=2;
                startActivity(new Intent(ListaInventarioT.this, InvRecep.class));
            }
        });
