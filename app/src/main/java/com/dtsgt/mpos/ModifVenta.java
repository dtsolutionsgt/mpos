...
public class ModifVenta extends PBase {
    ...
    private clsT_venta_modObj T_orden_modObj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modif_venta);
            ...
            T_orden_modObj=new clsT_venta_modObj(this,Con,db);
    ...
    private void save() {
        ...
        try {
            ...
            sql="DELETE FROM T_VENTA_MOD WHERE (ID="+gl.produid+")";
            db.execSQL(sql);
