...
public class extTextDlg {

    public  Dialog wdhandle;

    private TextView mTitleLabel,mBtnLeft,mBtnMid,mBtnRight,mText;
    ...
    private int bwidth=420,bheight=250,mwidth=0,mheight=0,mlines=6,mminlines=1;
    ...
    private void buildDialogbase(Activity activity,String titletext,String butleft,String butmid,String butright) {
        ...
        dialog.setContentView(R.layout.exttextdlg);
        ...
        mText = dialog.findViewById(R.id.lbltext);
    ...
    public void show() {
        ...
        fwidth = displayMetrics.widthPixels;fwidth=(int) (0.8*fwidth);
