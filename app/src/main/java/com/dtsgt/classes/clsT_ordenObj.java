...
public class clsT_ordenObj {
    ...
    private String sel="SELECT * FROM T_orden";
    private String sql;
    public ArrayList<clsClasses.clsT_orden> items= new ArrayList<clsClasses.clsT_orden>();

    public clsT_ordenObj(Context context, BaseDatos dbconnection, SQLiteDatabase dbase) {
        cont=context;
        Con=dbconnection;
    ...
    public void add(clsClasses.clsT_orden item) {
        addItem(item);
    }

    public void update(clsClasses.clsT_orden item) {
        updateItem(item);
    }

    public void delete(clsClasses.clsT_orden item) {
        deleteItem(item);
    }
    ...
    public clsClasses.clsT_orden first() {
        return items.get(0);
    }
    ...
    private void addItem(clsClasses.clsT_orden item) {
    ...
    private void updateItem(clsClasses.clsT_orden item) {
    ...
    private void deleteItem(clsClasses.clsT_orden item) {
        sql="DELETE FROM T_orden WHERE (ID="+item.id+") AND (COREL='"+item.corel+"')";
        db.execSQL(sql);
    }

    private void deleteItem(int id) {
        sql="DELETE FROM T_orden WHERE id=" + id;
        db.execSQL(sql);
    }
    ...
    public String updateItemSql(clsClasses.clsT_orden item) {
