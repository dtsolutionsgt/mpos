...
public class ListAdaptOrden extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.lblNota = (TextView) convertView.findViewById(R.id.lblPeso);
		...
		if (nota.isEmpty()) {
			holder.lblNota.setVisibility(View.GONE);
		} else {
			holder.lblNota.setVisibility(View.VISIBLE);
		}
		...
		if(selectedIndex!= -1 && position == selectedIndex) {
            ...
            holder.lblNota.setTextColor(Color.WHITE);
        } else {
            ...
            holder.lblNota.setTextColor(tcolor);
		}
	...
	static class ViewHolder {
		TextView  lblCod, lblNombre,lblCant,lblPrec,lblDesc,lblTot, lblNota;
		ImageView imgFlag;
	}
