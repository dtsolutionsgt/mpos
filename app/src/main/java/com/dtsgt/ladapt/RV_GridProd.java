...
public class RV_GridProd extends RecyclerView.Adapter<RV_GridProd.MyViewHolder> {
    ...
    public RV_GridProd(List<clsMenu> itemList, String imgfold) {
        this.items = itemList;
        imgpath=imgfold;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RV_GridProd.MyViewHolder holder, int position) {
