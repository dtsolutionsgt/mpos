...
public class ListAdaptMovInv extends BaseAdapter {
	...
	public ListAdaptMovInv(Context context, ArrayList<clsClasses.clsCFDV> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = l_Inflater.inflate(R.layout.activity_list_view_mov_inv, null);
	...
	static class ViewHolder {
		TextView  lblFecha,lblValor, lblUUID;
	}
