...
public class ListAdaptGridProd extends BaseAdapter {
	...
	public ListAdaptGridProd(Context context, ArrayList<clsMenu> results, String imgfold,boolean horiz) {
		items = results;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            if (horizontal) {
                ...
                convertView = l_Inflater.inflate(R.layout.activity_list_view_gridventa_v, null);
            }
