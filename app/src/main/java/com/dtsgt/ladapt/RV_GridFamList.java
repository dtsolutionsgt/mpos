...
public class RV_GridFamList  extends RecyclerView.Adapter<RV_GridFamList.MyViewHolder> {
    ...
    public RV_GridFamList(List<clsMenu> itemList) {
        this.items = itemList;
    }
    ...
    @NonNull
    @Override
    public RV_GridFamList.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RV_GridFamList.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
