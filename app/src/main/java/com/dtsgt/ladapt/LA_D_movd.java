...
public class LA_D_movd extends BaseAdapter {

    private MiscUtils mu;
    private DateUtils du;
    private AppMethods app;

    private ArrayList<clsClasses.clsD_MovD> items= new ArrayList<clsClasses.clsD_MovD>();
    private int selectedIndex;
    private LayoutInflater l_Inflater;

    public LA_D_movd(Context context, PBase owner, ArrayList<clsClasses.clsD_MovD> results) {
        items = results;
