...
public class ListAdaptMenuGrid extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (items.get(position).Icon==15) holder.imgEst.setImageResource(R.drawable.cierre_dia);
        if (items.get(position).Icon==14) holder.imgEst.setImageResource(R.drawable.nowifi2);
