...
public class MantAlmacen extends PBase {
    ...
    private clsP_almacenObj holder;
    private clsClasses.clsP_almacen item=clsCls.new clsP_almacen();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mant_almacen2);
        ...
        holder =new clsP_almacenObj(this,Con,db);
